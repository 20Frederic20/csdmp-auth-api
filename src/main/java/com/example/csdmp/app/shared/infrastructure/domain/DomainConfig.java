...
import com.example.csdmp.app.auth.domain.repositories.UserRepository;
import com.example.csdmp.app.auth.domain.security.PasswordInterface;
import com.example.csdmp.app.auth.domain.security.TokenInterface;
import com.example.csdmp.app.auth.domain.services.AuthService;
import com.example.csdmp.app.auth.domain.services.PermissionService;
import com.example.csdmp.app.auth.domain.services.RoleService;
import com.example.csdmp.app.auth.domain.services.UserService;
